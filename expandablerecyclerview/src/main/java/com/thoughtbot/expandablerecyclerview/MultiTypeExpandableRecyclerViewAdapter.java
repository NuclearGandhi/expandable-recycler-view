...
public abstract class MultiTypeExpandableRecyclerViewAdapter<GVH extends GroupViewHolder, CVH extends ChildViewHolder>
    ...
    protected MultiTypeExpandableRecyclerViewAdapter(List<? extends IExpandableGroup> groups) {
        super(groups);
    }
     ...
     * </p>
     */
    protected int getChildViewType(int position, IExpandableGroup group, int childIndex) {
     ...
     * </p>
     */
    private int getGroupViewType(int position, IExpandableGroup group) {
        return super.getItemViewType(position);
    }
