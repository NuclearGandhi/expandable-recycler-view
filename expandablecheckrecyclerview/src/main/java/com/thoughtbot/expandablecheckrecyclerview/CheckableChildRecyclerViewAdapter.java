...
public abstract class CheckableChildRecyclerViewAdapter<GVH extends GroupViewHolder, CCVH extends CheckableChildViewHolder>
    ...
    protected CheckableChildRecyclerViewAdapter(List<? extends CheckedExpandableGroup> groups) {
        super(groups);
     ...
     */
    protected abstract CCVH onCreateCheckChildViewHolder(ViewGroup parent, int viewType);
     ...
     */
    protected abstract void onBindCheckChildViewHolder(CCVH holder, int flatPosition,
