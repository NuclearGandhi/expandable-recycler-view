...
public class MultiTypeCheckGenreAdapter
    ...
    public MultiTypeCheckGenreAdapter(List<? extends IExpandableGroup> groups) {
        super(groups);
    ...
    @Override
    public void onBindChildViewHolder(ChildViewHolder holder, int flatPosition, IExpandableGroup group,
                                      int childIndex) {
    ...
    public void clearChoices() {
        ...
        for (int i = 0; i < getGroups().size(); i++) {
            IExpandableGroup group = getGroups().get(i);
